...
/**
 * Setup optional telemetry sink with Honeycomb and OpenTelemetry.
 * If creds are available, start the SDK. If you use a different
 * service (DD, etc) for your telemetry, you can swap it out here
 * with your sink's SDK.
 */
